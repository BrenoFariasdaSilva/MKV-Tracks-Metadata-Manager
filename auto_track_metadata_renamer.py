...
def main() -> None:
    ...
    print(
        f"{BackgroundColors.BOLD}{BackgroundColors.GREEN}Welcome to the {BackgroundColors.CYAN}Automatic Track Metadata Renamer{BackgroundColors.GREEN} program!{Style.RESET_ALL}",
        end="\n\n",

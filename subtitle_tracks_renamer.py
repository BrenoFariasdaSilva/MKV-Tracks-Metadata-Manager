...
def main() -> None:
    ...
    print(
        f"{BackgroundColors.BOLD}{BackgroundColors.GREEN}Welcome to the {BackgroundColors.CYAN}Subtitle Tracks Renamer{BackgroundColors.GREEN} program!{Style.RESET_ALL}",
        end="\n\n",
